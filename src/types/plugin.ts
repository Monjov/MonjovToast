...
export declare interface BasePluginOptions extends BaseToastContainerOptions, BaseToastOptions {}
export declare interface PluginOption extends BasePluginOptions {
  /**
   * Callback executed when the toast container is mounted.
   *
   * Receives the Container vue instance as a parameter.
   */
  onMounted?: (containerComponent: ComponentPublicInstance, containerApp: App<Element>) => void
